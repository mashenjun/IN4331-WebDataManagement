...
urlpatterns = patterns('',
    ...
    url(r'^web_data_index/$', 'mysite.views.web_data_index'),
    ...
    url(r'^sha_poetry_list/([a-zA-Z\d\@_\' ]+)/$', 'mysite.views.sha_poetry_list'),
